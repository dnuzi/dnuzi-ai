// test/client.test.js
// Unit tests for HiazClient — API layer
"use strict";
...
describe("HiazClient", () => {
  ...
  describe("construction", () => {
    ...
    test("accepts custom sessionId and conversationId", () => {
      const c = new HiazClient({ sessionId: "s1", conversationId: "cid" });
  ...
  describe("chat()", () => {
    ...
    test("returns result string", async () => {
      ...
      expect(res.result).toBe("Hello from Hiaz AI!");
    });
    ...
    test("appends two entries to history per turn", async () => {
      ...
      expect(hist[1].content).toBe("Hello from Hiaz AI!");
    });
